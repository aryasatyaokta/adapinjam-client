...
@Component({
  selector: 'app-layout-marketing',
  standalone: true,
  imports: [CommonModule, RouterOutlet, RouterModule],
  templateUrl: './layout-marketing.component.html',
  styleUrls: ['./layout-marketing.component.css'],
})
export class LayoutMarketingComponent implements AfterViewInit, OnInit {
